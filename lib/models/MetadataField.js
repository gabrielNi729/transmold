...
var MetadataField = function () {
  ...
  (0, _createClass2["default"])(MetadataField, [{
    ...
    value: function addEnums(enums) {
      ...
      if (this.distributeType === _types["default"].DISTRIBUTE.CATEGORY) {
        enums.forEach(function (en) {
          ...
          } else if (_this.mapEnumsCode[en.getCode()] === 1) {
            console.error("".concat(prefix, ": enum ").concat(en.getCode(), " already exists for field ").concat(_this.name));
          } else {
            _this.mapEnumsCode[en.getCode()] = 1;
    ...
    key: "getDistributeType",
    value: function getDistributeType() {
