...
var _mysqlNumber2 = _interopRequireDefault(require("./mysql-cn/mysql-number"));

var _mysqlString2 = _interopRequireDefault(require("./mysql-cn/mysql-string"));

var _mysqlBoolean2 = _interopRequireDefault(require("./mysql-cn/mysql-boolean"));

var _mysqlDate2 = _interopRequireDefault(require("./mysql-cn/mysql-date"));

var _mysqlMonth2 = _interopRequireDefault(require("./mysql-cn/mysql-month"));

var _mysqlYear2 = _interopRequireDefault(require("./mysql-cn/mysql-year"));

var _mysqlTime2 = _interopRequireDefault(require("./mysql-cn/mysql-time"));

var _mysqlGeography2 = _interopRequireDefault(require("./mysql-cn/mysql-geography"));

var _mysqlAggregate2 = _interopRequireDefault(require("./mysql-cn/mysql-aggregate"));

var _mysqlConvert2 = _interopRequireDefault(require("./mysql-cn/mysql-convert"));
...
operatorContexts[_contextsTemplate["default"].MYSQL_CN] = [].concat((0, _toConsumableArray2["default"])(_mysqlNumber2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlString2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlBoolean2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlDate2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlMonth2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlYear2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlTime2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlGeography2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlConvert2["default"].ops), (0, _toConsumableArray2["default"])(_mysqlAggregate2["default"].ops));
var activeContext = '';
var operators = [];
var operatorsList = [];
var operatorsMap = {};
